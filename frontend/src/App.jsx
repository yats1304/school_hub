      ...
      <div className="pt-15">
        <Routes>
          ...
          <Route
            path="/"
            element={
              <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] bg-gradient-to-tr from-blue-100 via-purple-100 to-pink-100 sm:py-16 sm:px-8 rounded-lg shadow-md">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-6 text-center max-w-2xl leading-relaxed">
